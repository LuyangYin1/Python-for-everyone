...
plt.plot(df['Close'])
plt.plot(df_portfolio['Close']['AAPL']) 
plt.plot(df_portfolio['Close']['GOOG'])
plt.plot(df_portfolio['Close']['SPY'])
plt.plot(df_portfolio['Close']['MSFT'])
plt.plot(df_portfolio['Close']['TSLA'])